...
def run(cfg: DictConfig):
    ...
    print("train_dataset lens=", len(train_dataset))
    ...
    print("train_dataloader lens=", len(train_dataloader))
    ...
    if os.path.exists(base_dir):
        ...
        for folder in os.listdir(base_dir):  # 返回指定文件夹中包含的文件夹和文件名字列表 version_0,version_1
            version_id = int(folder.split('_')[1])  # 0,1
